...
for example in dataset:  # Process just a few examples for demonstration
    if counter < 3:
        ...
        prompt = f"Generate only one sentence using all of the following concepts: {concepts}. 
        Let's first understand the concepts and devise a plan how to create a sentence. Then, let's carry out the plan to solve the problem step by step."

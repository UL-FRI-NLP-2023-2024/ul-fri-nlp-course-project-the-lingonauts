...
with open("outputs/commonsenseqa_baseline.txt", "w") as file:
    ...
    for example in dataset:
            ...
            formatted_question = (
                ...
                + f", which one is correct?  Answer only with one of the following A, B, C, D or E. The final output should be formatted as: 'Correct answer letter: <letter>', where <letter> is A,B,C,D or E. Answer with one letter only in the required format. Do not include any additional information. [/INST]\n{tokenizer.eos_token}\n"
            )
